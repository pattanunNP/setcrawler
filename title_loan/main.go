...
func main() {
	...
	initialpayload := `{"ProductIdList":"84,167,128,146,139,140,227,327,379,138,277,3,185,166,137,351,77,330","Page":1,"Limit":3}`
	...
	for page := 1; page <= totalPages; page++ {
		...
		payload := fmt.Sprintf(`{"ProductIdList":"84,167,128,146,139,140,227,327,379,138,277,3,185,166,137,351,77,330","Page":%d,"Limit":3}`, page)
