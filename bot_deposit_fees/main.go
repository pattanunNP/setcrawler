	...
	for page := 1; page <= totalPages; page++ {
		...
		for i := 1; i <= 3; i++ {
			...
			fees := pkg.ProductFees{
				AccountMaintenanceFee:             pkg.ExtractFeeArray(doc, "attr-AccountMaintenanceFee", col),
				StatementRequireFee:               pkg.ExtractFeeArrayPtr(doc, "attr-StatementRequireFee", col),
				StatementRequireSixMonth:          pkg.ExtractFeeArray(doc, "attr-StatementRequireSixMonth", col),
				StatementRequireSixMonthToTwoYear: pkg.ExtractFeeArray(doc, "attr-StatementRequireSixMonthToTwoYear", col),
				StatementRequireTwoYear:           pkg.ExtractFeeArray(doc, "attr-StatementRequireTwoYear", col),
				ShortMessageService:               pkg.ExtractFeeArray(doc, "attr-ShortMessageService", col),
				ShortMessageServiceFeeMonthly:     pkg.ExtractFeeArray(doc, "attr-ShortMessageServiceFeeMonthy", col),
				ShortMessageServiceAnnualFee:      pkg.ExtractFeeArray(doc, "attr-ShortMessageServiceAnnualFee", col),
				LostPassBookFee:                   pkg.ExtractFeeArray(doc, "attr-LostPassBookFee", col),
				AccountCloseFee:                   pkg.ExtractFeeArray(doc, "attr-AccountCloseFee", col),
			}

			numericFees := pkg.NumericProductFees{
				AccountMaintenanceFee:             pkg.ExtractNumericValue(strings.Join(fees.AccountMaintenanceFee, " ")),
				StatementRequireFee:               pkg.ExtractNumericValue(strings.Join(fees.StatementRequireFee, " ")),
				StatementRequireSixMonth:          pkg.ExtractNumericValue(strings.Join(fees.StatementRequireSixMonth, " ")),
				StatementRequireSixMonthToTwoYear: pkg.ExtractNumericValue(strings.Join(fees.StatementRequireSixMonthToTwoYear, " ")),
				StatementRequireTwoYear:           pkg.ExtractNumericValue(strings.Join(fees.StatementRequireTwoYear, " ")),
				ShortMessageService:               pkg.ExtractNumericValue(strings.Join(fees.ShortMessageService, " ")),
				ShortMessageServiceFeeMonthly:     pkg.ExtractNumericValue(strings.Join(fees.ShortMessageServiceFeeMonthly, " ")),
				ShortMessageServiceAnnualFee:      pkg.ExtractNumericValue(strings.Join(fees.ShortMessageServiceAnnualFee, " ")),
				LostPassBookFee:                   pkg.ExtractNumericValue(strings.Join(fees.LostPassBookFee, " ")),
				AccountCloseFee:                   pkg.ExtractNumericValue(strings.Join(fees.AccountCloseFee, " ")),
			}

			general := pkg.GeneralFees{
				CoinCollectFee:                         pkg.ExtractFeeArrayPtr(doc, "attr-CoinCollectFee", col),
				BranchFee:                              pkg.ExtractFeeArrayPtr(doc, "attr-BRFee", col),
				KioskOtherFee:                          pkg.ExtractFeeArrayPtr(doc, "attr-KioskOtherFee", col),
				KioskFee:                               pkg.ExtractFeeArrayPtr(doc, "attr-KioskFee", col),
				AgentFee:                               pkg.ExtractFeeArrayPtr(doc, "attr-AgentFee", col),
				ShopAgentFee:                           pkg.ExtractFeeArrayPtr(doc, "attr-ShopAgentFee", col),
				PostAgentFee:                           pkg.ExtractFeeArrayPtr(doc, "attr-PostAgentFee", col),
				TopupAgentFee:                          pkg.ExtractFeeArrayPtr(doc, "attr-TopupAgentFee", col),
				OtherAgentFee:                          pkg.ExtractFeeArrayPtr(doc, "attr-OtherAgentFee", col),
				TransferBetweenSavingCurrentAccountFee: pkg.ExtractFeeArrayPtr(doc, "attr-TransferBetweenSavingCurrentAccoutnFee", col),
				TransferBetweenBankingFee:              pkg.ExtractFeeArrayPtr(doc, "attr-TransferBetweenBankingFee", col),
			}

			numericGeneral := pkg.NumericGeneralFees{
				CoinCollectFee:                         pkg.ExtractNumericValue(strings.Join(general.CoinCollectFee, " ")),
				BranchFee:                              pkg.ExtractNumericValue(strings.Join(general.BranchFee, " ")),
				KioskOtherFee:                          pkg.ExtractNumericValue(strings.Join(general.KioskOtherFee, " ")),
				KioskFee:                               pkg.ExtractNumericValue(strings.Join(general.KioskFee, " ")),
				AgentFee:                               pkg.ExtractNumericValue(strings.Join(general.AgentFee, " ")),
				ShopAgentFee:                           pkg.ExtractNumericValue(strings.Join(general.ShopAgentFee, " ")),
				PostAgentFee:                           pkg.ExtractNumericValue(strings.Join(general.PostAgentFee, " ")),
				TopupAgentFee:                          pkg.ExtractNumericValue(strings.Join(general.TopupAgentFee, " ")),
				OtherAgentFee:                          pkg.ExtractNumericValue(strings.Join(general.OtherAgentFee, " ")),
				TransferBetweenSavingCurrentAccountFee: pkg.ExtractNumericValue(strings.Join(general.TransferBetweenSavingCurrentAccountFee, " ")),
				TransferBetweenBankingFee:              pkg.ExtractNumericValue(strings.Join(general.TransferBetweenBankingFee, " ")),
			}

			otherFees := pkg.OtherFees{
				OtherFees: pkg.ExtractFeeArrayPtr(doc, "attr-OtherFee", col),
			}
			...
			depositFess = append(depositFess, pkg.DepositFee{
				...
				Product:            product,
				Fees:               fees,
				NumericProductFees: numericFees,
				GeneralFees:        general,
				NumericGeneralFees: numericGeneral,
				OtherFees:          otherFees,
